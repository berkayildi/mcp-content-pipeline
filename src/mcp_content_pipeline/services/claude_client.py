...
Given a YouTube video transcript, produce EXACTLY this JSON structure:
{
  ...
  "twitter_hook": "see rules below",
  "topics": ["topic1", "topic2"]
}

TWITTER HOOK RULES (strictly under 280 characters including hashtags):
...
IMPORTANT: All output must be in English. If the transcript is in another language, translate all content (key_takeaways, tldr, twitter_hook) into fluent English.
